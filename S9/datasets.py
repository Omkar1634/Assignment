...
def load_data_S9():
    train_transform = AlbumentationsTransform(A.Compose([
        ...
        A.CoarseDropout(max_holes=1, min_holes=1, max_height=16, min_height=16, max_width=16, min_width=16, fill_value=(0.49139968, 0.48215827, 0.44653124), mask_fill_value=None),
