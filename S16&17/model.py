...
class PositionalEmbedding(pl.LightningModule):
    def __init__(self,d_model:int,seq_len:int,dropout:float):
        ...
        # This creates [0,1,2,3,..,seq_len] and unsqueeze to [[0],[1],[2],..[seq_len]]
...
class MultiHeadAttentionBlock(pl.LightningModule):
    ...
    def attention(self, query, key, value, mask, dropout):
        ...
        if mask is not None:
            ...
            # where ever mask is 0 it is filled with a smaller number
    ...
    def forward(self, q, k, v, mask):
        ...
        x, _ = self.attention(query, key, value, mask, self.dropout)  # Use self.attention() here
...
class Transformer(pl.LightningModule):
    def __init__(self, encoder:Encoder,decoder:Decoder,src_emb:InputEmbedding,tgt_emd:InputEmbedding,src_pos:PositionalEmbedding,tgt_pos:PositionalEmbedding,projection_layer:ProjectionLayer ): 
        super().__init__()
        self.encoder = encoder
        self.decoder = decoder
        self.src_emb = src_emb
        self.tgt_emb = tgt_emd
